...
# adamliao@ChundeMac-mini PythonWeb % source venv/bin/activate
# (venv) adamliao@ChundeMac-mini PythonWeb % /Users/adamliao/文件/PythonWeb/venv/bin/python /Users/adamliao/文件/PythonWeb/gold/gold_usd_twd_macd_analysis2.py  
